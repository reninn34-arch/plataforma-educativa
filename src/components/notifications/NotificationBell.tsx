  ...
  return (
    <div ref={ref} className="relative">
      ...
      >
        <Bell size={20} />
        {unreadCount > 0 && (
          <span className="absolute -top-0.5 -right-0.5 min-w-[1.125rem] h-5 rounded-full bg-destructive text-white text-[10px] font-bold flex items-center justify-center shadow-sm px-1">
      ...
      {open && (
        <div className="absolute right-0 top-full mt-2 w-[85vw] max-w-sm sm:w-96 bg-card rounded-2xl border border-border shadow-xl z-50 overflow-hidden">
          ...
          <div className="max-h-[60vh] sm:max-h-80 overflow-y-auto">
            ...
            {!isLoading && notificaciones.length === 0 && (
              <div className="py-8 text-center">
                ...
                <p className="text-xs text-muted-foreground font-medium">No hay notificaciones</p>
              </div>
            )}
