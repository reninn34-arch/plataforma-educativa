      ...
      <div className="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8 pb-24 lg:pb-8 space-y-6">
        ...
        <div className="bg-card rounded-2xl border border-border p-6 shadow-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6 pt-6 border-t border-slate-100">
            <div className="bg-muted rounded-xl p-4">
              ...
              <p className="font-semibold text-foreground">{profile?.cedula || "—"}</p>
            </div>
            <div className="bg-muted rounded-xl p-4">
              <div className="flex items-center gap-2 text-slate-400 mb-1.5">
                <Mail size={14} />
              ...
              <p className="font-semibold text-foreground">{profile?.email || "No registrado"}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-card rounded-2xl border border-border p-6 shadow-sm">
          <div className="flex items-center gap-2 mb-5">
            ...
            <div>
              <h3 className="font-bold text-foreground">Cambiar PIN</h3>
          ...
          <form onSubmit={handleChangePin} className="space-y-4">
            <div>
              <label className="text-xs font-semibold text-muted-foreground mb-1.5 block">PIN Actual</label>
            ...
            <div>
              ...
              <input
                ...
                maxLength={4}
                className="w-full h-11 rounded-xl border border-border bg-card px-4 text-sm font-bold tracking-[0.3em] placeholder:tracking-normal focus:border-indigo-300 focus:ring-2 focus:ring-indigo-100 focus:outline-none transition-all"
                placeholder="····"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                maxLength={4}
                className={`w-full h-11 rounded-xl border bg-card px-4 text-sm font-bold tracking-[0.3em] placeholder:tracking-normal focus:outline-none transition-all ${
                  confirmPin && confirmPin !== newPin
                    ? "border-red-300 focus:border-red-400 focus:ring-2 focus:ring-red-100"
                    : "border-border focus:border-indigo-300 focus:ring-2 focus:ring-indigo-100"
                }`}
                placeholder="····"
              />
              {confirmPin && confirmPin !== newPin && (
            ...
            <Button
              ...
              className="w-full gap-2 h-11 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white font-semibold disabled:opacity-50"
            >
        ...
        <div className="text-center">
          <p className="text-xs text-slate-400">Atlas Edu — PCEI 2024</p>
        </div>
      </div>
      <StudentBottomNav />
    </div>
