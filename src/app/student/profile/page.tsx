          ...
          <form onSubmit={handleChangePin} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                maxLength={4}
                className="w-full h-11 rounded-xl border border-slate-200 bg-white px-4 text-sm font-bold tracking-[0.3em] placeholder:tracking-normal focus:border-indigo-300 focus:ring-2 focus:ring-indigo-100 focus:outline-none transition-all"
                placeholder="····"
              />
            </div>
