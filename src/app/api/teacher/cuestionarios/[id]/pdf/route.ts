/**
 * @swagger
 * /api/teacher/cuestionarios/{id}/pdf:
 *   get:
 *     summary: Exportar cuestionario a PDF
 *     description: Genera y descarga un archivo PDF con el contenido del cuestionario, incluyendo preguntas, opciones y respuestas correctas.
 *     tags: [Docentes]
 *     security:
 *       - bearerAuth: []
 *     parameters:
